...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=0.99\textwidth]{figures_intro/hindley_2020_GWMF.png}
...
\begin{figure*}[ht]
    \centering
    \includegraphics[width=0.99\textwidth]{figures_intro/Skerlak_Fold.png}
...
% flow has to be zonal again therefore above tropopause, too!
